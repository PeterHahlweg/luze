...
use std::{collections::{HashMap, HashSet}, env, fmt, fs, io, path::{Path, PathBuf}, process::Command};
...
impl ID {
    ...
    /// Returns `None` if all 26 letter slots at the trailing segment are exhausted.
